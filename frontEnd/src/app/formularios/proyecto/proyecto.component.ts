...
export class ProyectoComponent implements OnInit {
  ...
  listaParametros:object;
  alerta: boolean = false;
  mensajeAlerta: string;       
  responsablesProyecto: ResponsableProyectoModel[]= [];
  fechaInicio: Date;
  fechaFin: Date;
  edicion: boolean;  
  ...
  obtenrParametros(){
    this.proyectoService.ObtenerParametros()
      .subscribe(resp => {
        this.listaParametros = JSON.parse(resp.mensaje1)[0];
      }, (error) => {
  ...
  nuevoFormulario() {
    this.formGroup = this.fb.group({
      ...
      cliente: ['', [Validators.required, Validators.maxLength(50), Validators.minLength(5), this.validarTexto]],
      proyecto: ['', [Validators.required, Validators.maxLength(50), Validators.minLength(5), this.validarTexto]],
      descripcion: ['', [Validators.required, Validators.maxLength(100), Validators.minLength(5), this.validarTexto]],
      ...
      clasificacion1: ['0', [Validators.required, Validators.maxLength(5), this.validarCombo]],
      clasificacion2: ['0', [Validators.required, Validators.maxLength(5), this.validarCombo]],
      clasificacion3: ['0', [Validators.required, Validators.maxLength(5), this.validarCombo]],
      ingreso: [false, []],
      costo: [false, []],
      gasto: [false, []],
      activo: [true, []]
  ...
  edicionFormulario() {
    ...
    this.formGroup = this.fb.group({
      ...
      cliente: [this.inputproyectoModel.cliente, [Validators.required, Validators.maxLength(50), Validators.minLength(5), this.validarTexto]],
      ...
      descripcion: [this.inputproyectoModel.descripcion, [Validators.required, Validators.maxLength(100), Validators.minLength(5), this.validarTexto]],
      ...
      clasificacion1: [this.inputproyectoModel.clasificacion1, [Validators.required, Validators.maxLength(5), this.validarCombo]],
      clasificacion2: [this.inputproyectoModel.clasificacion2, [Validators.required, Validators.maxLength(5), this.validarCombo]],
      clasificacion3: [this.inputproyectoModel.clasificacion3, [Validators.required, Validators.maxLength(5), this.validarCombo]],
